...
//import eduard.vitko.Internet_Service.filter.JwtAuthenticationFilter;
//
...
//        customAuthenticationFilter.setFilterProcessesUrl("/user/generate-token");
//        http.csrf().disable();
...
//        http.authorizeRequests().antMatchers(POST, "/user/generate-token/**").permitAll();
